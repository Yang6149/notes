...
### URL
 ...
 ![img](https://camo.githubusercontent.com/b61eb498c8b9458916441d9341d3975b6e1134cf/68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f38343431623263342d646361372d346436622d386566622d6632326566636361663333312e706e67)   
...
```
 ...
 ![img](https://camo.githubusercontent.com/1fdcf70fd0e44a9b77beecc8983b4e2e8afde712/68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f64633030663730652d633563382d346432302d626166312d3264373030313461393765332e6a7067) 
...
有 4 种类型的首部字段：通过首部字段、请求首部字段、响应首部字段和实体首部字段。
...
### 连接管理
 ...
 ![img](https://camo.githubusercontent.com/fff51791890e426ceac37c4de1b523f46fa7e62e/68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f48545450315f785f436f6e6e656374696f6e732e706e67) 
...
* 用户察觉得到正向代理的存在。 
 ...
 ![img](https://camo.githubusercontent.com/edb036138174e2c5c192bc3ddb3f60a8f56553e9/68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f61333134626237392d356231382d346536332d613937362d3334343862666661366631622e706e67) 
...
## 七、HTTP/2.0
 ...
 ![img](https://pic3.zhimg.com/80/b1e608ddb7493608efea3e76912aabe1_720w.jpg) 

由于pipelining 无法保证顺序，且难度太大，chrome浏览器默认关闭，这个时候就要用到HTTP/2
...
在 HTTP/2 中，头部和数据被分割为更小的消息和帧，并对它们进行二进制编码。

 HTTP/2 通信都在一个连接上完成，这个连接可以承载任意数量的双向数据流。

过去，HTTP 性能优化不再高宽带而在低延迟。因为 TCP 会进行自我调节（慢启动），由于 HTTP/2 通过让所有数据流公用同一个连接，可以更有效地使用 TCP 连接，让高宽带也真正服务 HTTP 地性能提升。
...
HTTP/1.1 并不支持 HTTP 首部压缩，为此 SPDY 和 HTTP/2 应运而生，SPDY 使用的是普通地 DEFLATE 算法，而 HTTP/2 则使用了专门为首部压缩的 HPACK 算法

 ![img](https://pic3.zhimg.com/80/c41c386f03b41f149a53fb17f520dd8d_720w.jpg) 
...
- 加密层 0RTT 就能建立加密连接。
 ...
 ![img](https://image.fundebug.com/2019-03-06-7.png) 
...
同 HTTP2.0 一样，同一条 QUIC 连接上可以创建多个 stream，来发送多个 HTTP 请求，但是，QUIC 是基于 UDP 的，一个连接上的多个 stream 之间没有依赖。比如下图中 stream2 丢了一个 UDP 包，不会影响后面跟着 Stream3 和 Stream4，不存在 TCP 队头阻塞。虽然 stream2 的那个包需要重新传，但是 stream3、stream4 的包无需等待，就可以发给用户。
 ...
 ![img](https://image.fundebug.com/2019-03-06-8.png) 
...
这样只要对 QUIC 报文任何修改，接收端都能够及时发现，有效地降低了安全风险。
 ...
 ![img](https://image.fundebug.com/2019-03-06-9.png) 
